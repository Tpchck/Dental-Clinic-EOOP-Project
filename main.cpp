...
int main() {
    ...
    // 7.2 Printing all appointments in the clinics
    ...
    // 8. Printing all dentists in the clinics
    clinic1.printAllDentists();

    // 9. Printing all patients in the clinics
    clinic1.printAllPatients();

    // 10. Printing all appointments in the clinics
    clinic1.printAllAppointments();

    // 11. Removing an appointment
    clinic1.removeAppointment("2024-04-01", "10:00", &patient1);

    // 12.1 Add the treatments to patients and dentists
    ...
    // 12.2 Print the treatments of patients
    patient1.printTreatments();

    // 13. Print the clinics of patients
    patient1.printClinics();
    patient2.printClinics();

    // 14. Print the treatments dentists can perform
    dentist1.printTreatments();
    dentist2.printTreatments();

    // 15. Print the clinic of a dentist
    dentist1.printClinics();

    // 16. Print the patients of a dentist
    dentist1.printPatients();
    dentist2.printPatients();

    // 17. Print the dentists of a patient
    ...
    // 8. Attempt to find a treatment that does not exist
    Treatment* treatment3 = clinic1.findTreatment("Nonexistent Treatment");

    // 9. Attempt to add a clinic to a patient who is already registered in that clinic
